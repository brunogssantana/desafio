    ...
    <div id='wrapperContent' class='content container-fluid'>
        ...
        <div class='card-body'>
            <h5 class="card-title mb-5">Cliente</h5>
                    ...
                    <form action="assets/_editar_produto.php" method="POST">
                    <input type="text" class="form-control form-control-lg" name="idProduto" value="<?php echo $idProduto ?>" style="display: none;" >
                    ...
                    <textarea class="form-control" id="" name="descricao" rows="8"><?php echo $descricao; ?></textarea>
                    </div>

                    <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Valor:</span>
                    <input type="cpf" class="form-control" name="preco" value="<?php echo $preco; ?>" autocomplete="off" required>
                    </div>
                   </div>
